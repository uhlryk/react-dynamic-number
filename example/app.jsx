        ...
        <div className="col-md-10 com-sm-offset-1 col-lg-8 offset-md-2">
          ...
          <form name="directiveForm">
            <div className="form-group row">
              <label className="col-form-label">Number may be positive or negative, decimal separator comma, integer 5 chars, fraction 5 chars (in addition gets focus)</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Number may be positive or negative, decimal separator dot, integer 6 chars, fraction 2 chars</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Number may be only positive, decimal separator dot, integer 6 chars, fraction 2 chars</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Number may be only negative, decimal separator dot, integer 6 chars, fraction 2 chars</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Decimal separator dot, thousand separator comma, integer 10 chars, fraction 3 chars</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Decimal separator dot, thousand separator space, integer 10 chars, fraction 3 chars</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Decimal separator dot, thousand separator space, integer 10 chars, fraction 3 chars, base value 1200.05</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Decimal separator comma, thousand separator space, integer 10 chars, fraction 3 chars, base value 0.05</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Decimal separator comma, no thousand separator, integer 10 chars, fraction 3 chars, base value 0.05</label>
            ...
            <div className="form-group row">
              <label className="col-form-label">Number may be positive or negative, decimal separator comma, integer 5 chars, fraction 5 chars (in addition highlights on bad input)</label>
