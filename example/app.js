...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);var _dynamicNumber=__webpack_require__(160);var _dynamicNumber2=_interopRequireDefault(_dynamicNumber);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var DynamicNumberComponent=function(_React$Component){_inherits(DynamicNumberComponent,_React$Component);function DynamicNumberComponent(props){_classCallCheck(this,DynamicNumberComponent);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(DynamicNumberComponent).call(this,props));_this.dynamicNumber=new _dynamicNumber2.default();_this.dynamicNumber.separator=_this.props.separator;_this.dynamicNumber.integer=_this.props.integer;_this.dynamicNumber.fraction=_this.props.fraction;_this.dynamicNumber.positive=_this.props.positive;_this.dynamicNumber.negative=_this.props.negative;_this.dynamicNumber.thousand=_this.props.thousand;_this.dynamicNumber.calculate(props.value,props.value,'0');_this.state={modelValue:_this.dynamicNumber.modelValue,viewValue:_this.dynamicNumber.viewValue};_this.onChange=_this.onChange.bind(_this);return _this;}_createClass(DynamicNumberComponent,[{key:'onChange',value:function onChange(evt){var _this2=this;var target=evt.target;this.dynamicNumber.calculate(evt.target.value,this.state.modelValue,this.state.viewValue,target.selectionStart);var modelValue=this.dynamicNumber.modelValue;var viewValue=this.dynamicNumber.viewValue;if(this.props.onChange){this.props.onChange(evt,modelValue,viewValue);}this.setState({modelValue:modelValue,viewValue:viewValue},function(){ //after value change we set cursor position
	if(target.selectionStart!==undefined&&target.selectionStart!==null){target.selectionStart=target.selectionEnd=_this2.dynamicNumber.cursorPosition;}});}},{key:'render',value:function render(){return _react2.default.createElement('input',{type:'text',className:this.props.className,value:this.state.viewValue,onChange:this.onChange});}}]);return DynamicNumberComponent;}(_react2.default.Component);DynamicNumberComponent.propTypes={value:_react2.default.PropTypes.number,integer:_react2.default.PropTypes.number,fraction:_react2.default.PropTypes.number,positive:_react2.default.PropTypes.bool,negative:_react2.default.PropTypes.bool,separator:function separator(props,propName){if(props[propName]!==undefined&&props[propName]!==','&&props[propName]!=='.'){return new Error('separator have to be comma or dot char');}},thousand:function thousand(props,propName){if(props[propName]!==undefined&&props[propName]!==true&&props[propName]!==false&&props[propName]!==' '){return new Error('thousand have to be bool value or space character');}}};exports.default=DynamicNumberComponent;
