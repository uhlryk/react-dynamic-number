...
/******/ 	var hotCurrentHash = "ed81faaa2e739b9ee194"; // eslint-disable-line no-unused-vars
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();(function(){var enterModule=__webpack_require__(0).enterModule;enterModule&&enterModule(module);})();var _react=__webpack_require__(4);var _react2=_interopRequireDefault(_react);var _propTypes=__webpack_require__(16);var _propTypes2=_interopRequireDefault(_propTypes);var _dynamicNumber=__webpack_require__(21);var _dynamicNumber2=_interopRequireDefault(_dynamicNumber);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _objectWithoutProperties(obj,keys){var target={};for(var i in obj){if(keys.indexOf(i)>=0)continue;if(!Object.prototype.hasOwnProperty.call(obj,i))continue;target[i]=obj[i];}return target;}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var DynamicNumberComponent=function(_React$Component){_inherits(DynamicNumberComponent,_React$Component);function DynamicNumberComponent(props){_classCallCheck(this,DynamicNumberComponent);var _this=_possibleConstructorReturn(this,(DynamicNumberComponent.__proto__||Object.getPrototypeOf(DynamicNumberComponent)).call(this,props));_this.dynamicNumber=new _dynamicNumber2.default();_this.dynamicNumber.separator=_this.props.separator;_this.dynamicNumber.integer=_this.props.integer;_this.dynamicNumber.fraction=_this.props.fraction;_this.dynamicNumber.positive=_this.props.positive;_this.dynamicNumber.negative=_this.props.negative;_this.dynamicNumber.thousand=_this.props.thousand;_this.calculator=_this.dynamicNumber.clone();_this.calculator.calculate(_this.calculator.calculateViewFromModel(props.value),props.value,"0");_this.state={modelValue:_this.calculator.modelValue,viewValue:_this.calculator.viewValue};_this.onChange=_this.onChange.bind(_this);_this.focus=_this.focus.bind(_this);return _this;}_createClass(DynamicNumberComponent,[{key:'focus',value:function focus(){if(this.input&&this.input.focus){this.input.focus();}}},{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){if(nextProps.value===''){this.setState({modelValue:'',viewValue:''});}else if(nextProps.value!==undefined){this.calculator.calculate(this.calculator.calculateViewFromModel(nextProps.value),nextProps.value,"0");this.setState({modelValue:this.calculator.modelValue,viewValue:this.calculator.viewValue});}}// from http://stackoverflow.com/a/2897229/4138339
},{key:'getCaretPosition',value:function getCaretPosition(oField){var iCaretPos=0;if(document.selection){oField.focus();var oSel=document.selection.createRange();oSel.moveStart('character',-oField.value.length);iCaretPos=oSel.text.length;}else if(oField.selectionStart||Number(oField.selectionStart)===0)iCaretPos=oField.selectionDirection==='backward'?oField.selectionStart:oField.selectionEnd;return iCaretPos;}},{key:'fireBadInput',value:function fireBadInput(){var onBadInput=this.props.onBadInput;if(typeof onBadInput==='function'){onBadInput();}}},{key:'onChange',value:function onChange(evt){var _this2=this;var target=evt.target;var onChange=this.props.onChange;var isValid=this.dynamicNumber.calculate(evt.target.value,this.state.modelValue,this.state.viewValue,this.getCaretPosition(target));if(!isValid){this.fireBadInput();}var modelValue=this.dynamicNumber.modelValue;var viewValue=this.dynamicNumber.viewValue;if(typeof onChange==='function'){onChange(evt,modelValue,viewValue);}this.setState({modelValue:modelValue,viewValue:viewValue},function(){//after value change we set cursor position
if(target.selectionStart!==undefined&&target.selectionStart!==null){target.selectionStart=target.selectionEnd=_this2.dynamicNumber.cursorPosition;}});}},{key:'render',value:function render(){var _this3=this;var _props=this.props,separator=_props.separator,integer=_props.integer,fraction=_props.fraction,positive=_props.positive,negative=_props.negative,thousand=_props.thousand,onBadInput=_props.onBadInput,other=_objectWithoutProperties(_props,['separator','integer','fraction','positive','negative','thousand','onBadInput']);return _react2.default.createElement('input',_extends({type:'text',ref:function ref(input){_this3.input=input;},placeholder:this.props.placeholder,className:this.props.className},other,{value:this.state.viewValue,onChange:this.onChange}));}}]);return DynamicNumberComponent;}(_react2.default.Component);DynamicNumberComponent.propTypes={value:_propTypes2.default.oneOfType([_propTypes2.default.number,function(props,propName){if(props[propName]!==''){return new Error('value must be a number or empty string');}}]),integer:_propTypes2.default.number,fraction:_propTypes2.default.number,positive:_propTypes2.default.bool,negative:_propTypes2.default.bool,separator:function separator(props,propName){if(props[propName]!==undefined&&props[propName]!==','&&props[propName]!=='.'){return new Error('separator have to be comma or dot char');}},thousand:function thousand(props,propName){if(props[propName]!==undefined&&props[propName]!==true&&props[propName]!==false&&props[propName]!==' '){return new Error('thousand have to be bool value or space character');}},placeholder:_propTypes2.default.string,// Pass this callback in props if you wish to konow when an illegal character is inputed.
// For instance, you may want to higlight input's background.
onBadInput:_propTypes2.default.func};var _default=DynamicNumberComponent;exports.default=_default;;(function(){var reactHotLoader=__webpack_require__(0).default;var leaveModule=__webpack_require__(0).leaveModule;if(!reactHotLoader){return;}reactHotLoader.register(DynamicNumberComponent,'DynamicNumberComponent','I:/WorkEpam/react-dynamic-number/src/index.jsx');reactHotLoader.register(_default,'default','I:/WorkEpam/react-dynamic-number/src/index.jsx');leaveModule(module);})();;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();(function(){var enterModule=__webpack_require__(0).enterModule;enterModule&&enterModule(module);})();var _react=__webpack_require__(4);var _react2=_interopRequireDefault(_react);var _reactDom=__webpack_require__(18);var _reactDom2=_interopRequireDefault(_reactDom);var _reactHotLoader=__webpack_require__(0);var _index=__webpack_require__(17);var _index2=_interopRequireDefault(_index);__webpack_require__(19);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var App=function(_React$Component){_inherits(App,_React$Component);function App(props){_classCallCheck(this,App);var _this=_possibleConstructorReturn(this,(App.__proto__||Object.getPrototypeOf(App)).call(this,props));_this.onChange=function(index){return function(evt,modelValue){var example=_this.state.example.slice();example[index]=modelValue;_this.setState({example:example});};};_this.onBadInput=function(){if(_this.timerId){return;}_this.input2Node.classList.add('is-invalid');_this.timerId=setTimeout(function(){delete _this.timerId;_this.input2Node.classList.remove('is-invalid');},200);};_this.state={example:[]};_this.state.example[6]=1200.05;_this.state.example[7]=0.05;_this.state.example[8]=0.05;return _this;}_createClass(App,[{key:'componentDidMount',value:function componentDidMount(){this.input.focus();}},{key:'componentWillUnmount',value:function componentWillUnmount(){if(this.timerId){clearTimeout(this.timerId);delete this.timerId;}}},{key:'render',value:function render(){var _this2=this;return _react2.default.createElement('div',{className:'container-fluid content'},_react2.default.createElement('div',{className:'col-md-10 com-sm-offset-1 col-lg-8 offset-md-2'},_react2.default.createElement('h1',{className:'mt-3'},'Example of react dynamic number component'),_react2.default.createElement('form',{name:'directiveForm'},_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Number may be positive or negative, decimal separator comma, integer 5 chars (in addition gets focus)'),_react2.default.createElement(_index2.default,{ref:function ref(input){return _this2.input=input;},className:'form-control',onChange:this.onChange(0),separator:',',integer:5,fraction:5}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[0])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Number may be positive or negative, decimal separator dot, integer 6 chars'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(1),separator:'.',integer:6,fraction:2}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[1])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Number may be only positive, decimal separator dot, integer 6 chars'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(2),separator:'.',integer:6,fraction:2,negative:false}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[2])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Number may be only negative, decimal separator dot, integer 6 chars'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(3),separator:'.',integer:6,fraction:2,positive:false}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[3])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Decimal separator dot, thousand separator comma, integer 10 chars'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(4),separator:'.',integer:10,fraction:3,thousand:true}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[4])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Decimal separator dot, thousand separator space, integer 10 chars'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(5),separator:'.',integer:10,fraction:3,thousand:' '}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[5])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Decimal separator dot, thousand separator space, integer 10 chars, base value 1200.05'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(6),separator:'.',integer:10,fraction:3,thousand:' ',value:this.state.example[6]}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[6])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Decimal separator comma, thousand separator space, integer 10 chars, base value 0.05'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(7),separator:',',integer:10,fraction:3,thousand:' ',value:this.state.example[7]}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[7])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Decimal separator comma, no thousand separator, integer 10 chars, base value 0.05'),_react2.default.createElement(_index2.default,{className:'form-control',onChange:this.onChange(8),separator:',',integer:10,fraction:3,value:this.state.example[8]}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[8])),_react2.default.createElement('div',{className:'form-group row'},_react2.default.createElement('label',{className:'col-form-label'},'Number may be positive or negative, decimal separator comma, integer 5 chars (in addition highlights on bad input)'),_react2.default.createElement(_index2.default,{ref:function ref(input){return _this2.input2Node=_reactDom2.default.findDOMNode(input);},onBadInput:this.onBadInput,className:'form-control',onChange:this.onChange(9),separator:',',integer:5,fraction:5}),_react2.default.createElement('div',null,'How looks model: ',this.state.example[9])))));}}]);return App;}(_react2.default.Component);var HotApp=(0,_reactHotLoader.hot)(module)(App);_reactDom2.default.render(_react2.default.createElement(HotApp,null),document.getElementById('app'));;(function(){var reactHotLoader=__webpack_require__(0).default;var leaveModule=__webpack_require__(0).leaveModule;if(!reactHotLoader){return;}reactHotLoader.register(App,'App','I:/WorkEpam/react-dynamic-number/example/app.jsx');reactHotLoader.register(HotApp,'HotApp','I:/WorkEpam/react-dynamic-number/example/app.jsx');leaveModule(module);})();;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(6)(module)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();(function(){var enterModule=__webpack_require__(0).enterModule;enterModule&&enterModule(module);})();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var DynamicNumber=function(){function DynamicNumber(){_classCallCheck(this,DynamicNumber);this._separator='.';this._integer=10;this._fraction=10;this._positive=true;this._negative=true;this._regexp=this._buildRegexp();this._isThousand=false;this._thousand=null;}_createClass(DynamicNumber,[{key:'clone',value:function clone(){var other=new DynamicNumber();other._separator=this._separator;other._integer=this._integer;other._fraction=this._fraction;other._positive=this._positive;other._negative=this._negative;other._regexp=this._regexp;other._isThousand=this._isThousand;other._thousand=this._thousand;other._cursor=this._cursor;return other;}},{key:'calculateViewFromModel',value:function calculateViewFromModel(){var modelValue=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;return this._createViewValueFromModel(modelValue);}},{key:'calculate',value:function calculate(){var rawViewValue=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;var oldModelValue=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var oldViewValue=arguments.length>2&&arguments[2]!==undefined?arguments[2]:'0';var cursorPosition=arguments.length>3&&arguments[3]!==undefined?arguments[3]:null;this._rawViewValue=rawViewValue;this._oldModelValue=oldModelValue;this._oldViewValue=oldViewValue;this._newModelValue=0;this._newViewValue='';this._cursor=cursorPosition;var value=String(this._rawViewValue);value=this._removeThousandSeparator(value);value=this._removeLeadingZero(value);if(value===''&&String(this._rawViewValue).charAt(0)==='0'){this._newModelValue=0;this._newViewValue='0';return true;}if(value===undefined||value===''){this._newModelValue=0;this._newViewValue='';return true;}if(value==='-'){this._newModelValue=0;this._newViewValue='-';return true;}//test fails, therefore we use old values
if(this._regexp.test(value)===false){this._newModelValue=this._oldModelValue;this._newViewValue=this._oldViewValue;return false;}// view value success 'correct view format' test
else{this._newModelValue=this._createModelValueFromView(value);this._newViewValue=this._createViewValueFromView(value);this._cursor=this._calculateNewCursorPosition();return true;}}},{key:'_calculateThousandSeparator',/**
...
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_RESULT__;(function() {
  ...
  // amd
  if ("function" !== "undefined" && __webpack_require__(43) !== null && __webpack_require__(44)) {
...
*/
var ba=__webpack_require__(3),ea=__webpack_require__(4),m=__webpack_require__(12),A=__webpack_require__(5),C=__webpack_require__(2),fa=__webpack_require__(14),ha=__webpack_require__(15),ja=__webpack_require__(13),ka=__webpack_require__(7);
...
var shallowEqual = _interopDefault(__webpack_require__(40));
var levenshtein = _interopDefault(__webpack_require__(23));
var PropTypes = _interopDefault(__webpack_require__(16));
var reactLifecyclesCompat = __webpack_require__(37);
var hoistNonReactStatic = _interopDefault(__webpack_require__(30));
